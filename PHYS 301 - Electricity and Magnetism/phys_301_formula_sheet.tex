...
\newcommand{\en}{\ep_0}
\newcommand{\mn}{\mu_0}
\newcommand{\rsep}{\mbox{$\resizebox{.09in}{.08in}{\includegraphics[trim= 1em 0 14em 0,clip]{assets/ScriptR}}$}}
\newcommand{\rsepb}{\mbox{$\resizebox{.09in}{.08in}{\includegraphics[trim= 1em 0 14em 0,clip]{assets/BoldR}}$}}
...
\begin{tabular}{p{13em}p{8em}}
    ...
    $\ds V_2(\r)=\cc\sum_{ij}\frac{Q_{ij}\hat r_i\hat r_j}{r^3}$ \\
\end{tabular}
